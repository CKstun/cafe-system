 ...
 * Displays required warning and controls: Cancel and "Yes, Delete Account" (bg-red-600 text-white rounded-xl)
 * Prevents self-deletion of currently logged-in account (id !== auth()->id())
 */
