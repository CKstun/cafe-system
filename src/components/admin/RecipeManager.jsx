...
/**
 * Dedicated Recipe & Bill of Materials (BOM) Settings Component
 * Mappings between raw inventory supplies (cups, lids, syrups) and menu variants.
...
export const RecipeManager = ({
  ...
  const [selectedSize, setSelectedSize] = useState(() => availableSizes[0] || '16oz');
