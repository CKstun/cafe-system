...
`,
  ...
  {
    path: 'app/Http/Controllers/Api/MenuItemController.php',
    category: 'Controller',
    description: 'Admin endpoint PUT /api/admin/menu-items/{id} handling transactional updates for product details, size variants, BOM recipe rules, and stock adjustments in a single DB transaction',
    code: `<?php
...
`,
  },
  {
    ...
    category: 'Controller',
    description: 'Laravel 13 API Controller for staff account CRUD, password resets, self-deletion guards, and is_active token revocation',
    code: `<?php
...
`,
  },
  {
    ...
    category: 'Controller',
    description: 'Laravel 13 Sanctum Authentication Controller with is_active deactivation guard and token management',
    code: `<?php
